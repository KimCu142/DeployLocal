...
export function Lights() {
  return (
    <>
      <spotLight color="#61dafb" position={[-10, -10, -10]} intensity={1} />
      <spotLight color="#61dafb" position={[-10, 0, 15]} intensity={1} />
      <spotLight color="#61dafb" position={[-5, 20, 2]} intensity={1} />
      <spotLight color="#f2056f" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#f2056f" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#b107db" position={[5, -10, 5]} intensity={1} />
    </>
  );
}
